...
def generate_page(output_path, date_str, day_str):
    c = canvas.Canvas(output_path, pagesize=(page_width, page_height))
    draw_dot_grid(c, 0, 0, page_width, page_height)
    draw_dial(c, cx_dial, cy_dial, date_str, day_str)
    c.save()
...
if __name__ == "__main__":
    ...
    generate_page(args.output_filename, args.month_date_str, args.day_str)
